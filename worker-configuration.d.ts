/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b85000ebdc614a056cc76eccc8a645c)
// Runtime types generated with workerd@1.20250726.0 2025-01-26 
declare namespace Cloudflare {
	interface Env {
		MODEL: "gemini-2.0-flash";
		ENV_MODEL: "@cf/baai/bge-m3";
		CF_POSTURL: string;
		CF_POST_DATA_URL: string;
		CF_ACCESS_CLIENT_ID: string;
		CF_ACCESS_CLIENT_SECRET: string;
		GOOGLE_GEMINI_API_KEY: string;
		WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_DB: string;
		CF_ACCOUNT_ID: string;
		GATEWAY_NAME: string;
		PUBLIC_REPO_TOKEN: string;
		GOOGLE_WORKFLOW: Workflow;
	}
}
